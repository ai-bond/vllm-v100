...
def fused_topk_bias(
    ...
    if scoring_func == "softmax":
        ...
        # Fallback to Python implementation (for torch.compile or edge cases)
        n_routed_experts = gating_output.shape[-1]

        if scoring_func == "softmax_fallback":
            scores = gating_output.softmax(dim=-1)
        elif scoring_func == "sigmoid_fallback":
        ...
        # For batch invariance, use sorted=True to ensure deterministic expert
        # selection
